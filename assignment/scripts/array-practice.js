...
let favoriteFoods = ["chicken fingers", "pizza rolls", "poke bowls", "tacos"];
...
favoriteFoods.push("ribs");
console.log("Added more food to the end,", favoriteFoods);
...
favoriteFoods[1] = "grapes";
console.log("Grapes replaced pizza rolls", favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
reversedFood = favoriteFoods.reverse(favoriteFoods.sort());
console.log("My favorite foods in reverse alpha order:", reversedFood);
...
console.log("Concat array:", favoriteFoodAndAnimals);

let spreadArray = [...favoriteFoods, ...animalArray];
